...
class emergencyleaveController extends Controller {
    ...
    public function Leave_attechements(Request $request) {
        try {
            $validated=Validator::make($request->all(), [ 'attechement_type_id'=>'required',
            ...
            // $leave=$request->location_latitude;
            // $leave1=$request->location_longitude;
            ...
            $path="reports/";
            $slash="/";
            // $path_location="reports/Location";
